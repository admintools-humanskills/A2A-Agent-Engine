...
class AgentVisualization {
    constructor(canvas) {
        ...
        // NPC animators
        this.npcs = {};
        ['hotel', 'flight', 'train', 'ticket', 'restaurant', 'merchandise', 'insurance'].forEach(k => {
    ...
    initStatusBar() {
        ...
        ['concierge', 'hotel', 'flight', 'train', 'ticket', 'restaurant', 'merchandise', 'insurance'].forEach(k => {
    ...
    resolveAgentKey(agentName) {
        ...
        const keys = ['hotel', 'flight', 'train', 'ticket', 'restaurant', 'merchandise', 'insurance'];
        ...
        if (name.includes('insurance') || name.includes('assurance') || name.includes('cardif') || name.includes('devis') || name.includes('prevoyance') || name.includes('retraite')) return 'insurance';
        return null;
    }
